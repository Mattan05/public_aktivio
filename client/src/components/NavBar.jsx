            ...
            <div className="navBar-container">
                <nav>
                    <ul className="navbar-ul">
                        <a href="#home"><li><span className="material-symbols-outlined">home</span></li></a>
...
{/*                         <a href="#login"><li><span className="material-symbols-outlined">login</span></li></a> */} { /* Om man är utloggad ska man komma till login eller register */}
                        <a href="#profile"><li><span className="material-symbols-outlined" /* alt="Profile-button" */>person</span></li></a>
                    </ul>
                </nav>
            </div>
        </>
